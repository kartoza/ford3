...
def get_qualification_test_object(newid=1):
    qualification_test_object_instance = Qualification.objects.create(
        id=newid,
        subfield_of_study_id=get_sub_field_of_study_test_object(),
        saqa_id=4,
        ...
        occupation_id=get_occupation_test_object(),
        campus_id=get_campus_test_object())

    qualification_test_object_instance.subjects.add(
        get_subject_test_object(1))
    qualification_test_object_instance.subjects.add(
        get_subject_test_object(2))
    qualification_test_object_instance.modules.add(
        get_module_test_object(1))
...
def get_requirement_test_object(newid=1):
    requirement_test_object_instance = Requirement.objects.create(
        ...
        qualification_id=get_qualification_test_object(1),
        assessment=True,
        interview=True,
...
def get_campus_test_object(newid=1):
    campus_test_object_instance = Campus.objects.create(
        id=newid,
        provider_id=get_provider_test_object(1),
        name='Object Test Name',
...
def get_sub_field_of_study_test_object(new_id=1):
    sub_field_of_study_test_object_instance = SubFieldOfStudy.objects.create(
        id=new_id,
        name='Object Test Name',
        field_of_study_id=get_field_of_study_test_object(1),
    )
